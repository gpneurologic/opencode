export const dict = {
  ...
  "command.session.autoclean": "تنظيف إخراج الأوامر",
  "command.session.autoclean.description": "إزالة إخراج أوامر الصدفة من سجل المحادثة",
  ...
  "toast.session.autoclean.success.title": "اكتمل التنظيف التلقائي",
  "toast.session.autoclean.success.description": "تمت إزالة {{count}} كتلة إخراج أوامر صدفة",
  "toast.session.autoclean.none.title": "لا يوجد ما يمكن تنظيفه",
  "toast.session.autoclean.none.description": "لم يتم العثور على إخراج أوامر صدفة في هذه الجلسة",
  "toast.session.autoclean.failed.title": "فشل التنظيف التلقائي",
  "toast.session.autoclean.failed.description": "تعذر إزالة إخراج أوامر الصدفة من هذه الجلسة",
