...
export const dict = {
  ...
  "command.session.autoclean": "清理命令输出",
  "command.session.autoclean.description": "从会话历史中移除 shell 命令输出",
  ...
  "toast.session.autoclean.success.title": "自动清理完成",
  "toast.session.autoclean.success.description": "已移除 {{count}} 个 shell 命令输出块",
  "toast.session.autoclean.none.title": "没有可清理的内容",
  "toast.session.autoclean.none.description": "此会话中未找到 shell 命令输出",
  "toast.session.autoclean.failed.title": "自动清理失败",
  "toast.session.autoclean.failed.description": "无法从此会话中移除 shell 命令输出",
