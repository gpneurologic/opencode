export const dict = {
  ...
  "command.session.autoclean": "Limpar saída de comandos",
  "command.session.autoclean.description": "Remover saída de comandos do shell do histórico da conversa",
  ...
  "toast.session.autoclean.success.title": "Limpeza automática concluída",
  "toast.session.autoclean.success.description": "Removidos {{count}} blocos de saída de comandos do shell",
  "toast.session.autoclean.none.title": "Nada para limpar",
  "toast.session.autoclean.none.description": "Nenhuma saída de comando do shell encontrada nesta sessão",
  "toast.session.autoclean.failed.title": "Falha na limpeza automática",
  "toast.session.autoclean.failed.description": "Não foi possível remover a saída de comandos do shell desta sessão",
