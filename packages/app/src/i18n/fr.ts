export const dict = {
  ...
  "toast.session.autoclean.success.title": "Nettoyage automatique terminé",
  "toast.session.autoclean.success.description": "{{count}} blocs de sortie de commandes shell supprimés",
  "toast.session.autoclean.none.title": "Rien à nettoyer",
  "toast.session.autoclean.none.description": "Aucune sortie de commande shell trouvée dans cette session",
  "toast.session.autoclean.failed.title": "Échec du nettoyage automatique",
