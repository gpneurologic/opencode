export const dict = {
  ...
  "command.session.autoclean": "コマンド出力をクリーンアップ",
  "command.session.autoclean.description": "会話履歴からシェルコマンドの出力を削除します",
  ...
  "toast.session.autoclean.success.title": "自動クリーンアップが完了しました",
  "toast.session.autoclean.success.description": "シェルコマンドの出力ブロックを {{count}} 個削除しました",
  "toast.session.autoclean.none.title": "クリーンアップ対象はありません",
  "toast.session.autoclean.none.description": "このセッションにはシェルコマンドの出力が見つかりませんでした",
  "toast.session.autoclean.failed.title": "自動クリーンアップに失敗しました",
  "toast.session.autoclean.failed.description": "シェルコマンドの出力をこのセッションから削除できませんでした",
