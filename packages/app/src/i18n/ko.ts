export const dict = {
  ...
  "command.session.autoclean": "명령 출력 정리",
  "command.session.autoclean.description": "대화 기록에서 셸 명령 출력 제거",
  ...
  "toast.session.autoclean.success.title": "자동 정리 완료",
  "toast.session.autoclean.success.description": "셸 명령 출력 블록 {{count}}개를 제거했습니다",
  "toast.session.autoclean.none.title": "정리할 항목 없음",
  "toast.session.autoclean.none.description": "이 세션에서 셸 명령 출력을 찾을 수 없습니다",
  "toast.session.autoclean.failed.title": "자동 정리 실패",
  "toast.session.autoclean.failed.description": "이 세션에서 셸 명령 출력을 제거할 수 없습니다",
