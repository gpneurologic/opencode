export const dict = {
  ...
  "command.session.autoclean": "Wyczyść wyjście poleceń",
  "command.session.autoclean.description": "Usuń wyjście poleceń powłoki z historii rozmowy",
  ...
  "toast.session.autoclean.success.title": "Automatyczne czyszczenie zakończone",
  "toast.session.autoclean.success.description": "Usunięto {{count}} bloków wyjścia poleceń powłoki",
  "toast.session.autoclean.none.title": "Brak elementów do wyczyszczenia",
  "toast.session.autoclean.none.description": "Nie znaleziono wyjścia poleceń powłoki w tej sesji",
  "toast.session.autoclean.failed.title": "Automatyczne czyszczenie nie powiodło się",
  "toast.session.autoclean.failed.description": "Nie udało się usunąć wyjścia poleceń powłoki z tej sesji",
