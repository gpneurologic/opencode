export const dict = {
  ...
  "command.session.autoclean.description": "Eliminar la salida de comandos del shell del historial de la conversación",
  ...
  "toast.session.autoclean.success.title": "Limpieza automática completada",
  ...
  "toast.session.autoclean.none.description": "No se encontró salida de comandos del shell en esta sesión",
  "toast.session.autoclean.failed.title": "Falló la limpieza automática",
  "toast.session.autoclean.failed.description": "No se pudo eliminar la salida de comandos del shell de esta sesión",
